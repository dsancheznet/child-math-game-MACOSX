...
say "Bienvenidos al juego para practicar multiplicaciones."
say "¿Cual es el número máximo al que limitar los multiplicadores?" &

read -p "¿Cual es el número máximo al que limitar los multiplicadores? " MAXIMO
...
for COUNT in {1..20}; do
  ...
  echo -e "$FONT_INVERT Quedan $((20 - COUNT)) preguntas."
	...
	say "¿Cuánto es $NUMBERONE por $NUMBERTWO? " &
	...
	say "$NUMBERONE por $NUMBERTWO es $RESULT"
done
